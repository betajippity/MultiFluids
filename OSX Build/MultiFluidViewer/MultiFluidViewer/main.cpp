...
#ifdef __APPLE__
#include <OpenGL/glu.h> // why does Apple have to put glut.h here...
#else
#include "gl/glu.h" // ...when everyone else puts it here?
#endif
...
bool read_frame(int newframe)
{
   ...
   strout << file_path << "FluidDataparticles_" << newframe << ".txt";
   printf("File path %s\n", strout.str().c_str());
